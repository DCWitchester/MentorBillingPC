...
{
    /// <summary>
    /// the original encryption class <= Works with decript.exe
    /// </summary>
    class Encryption
    {
        /// <summary>
    ...
    /// <summary>
    /// the new encryption class <= doesn't work with decript.exe yet. 
    /// When it will it will replace Encryption
    /// </summary>
    class EncryptionV2
    {
        /// <summary>
        /// the password is a bit of Malbolge Code: Impossible to break <= chances to recreate -> Impossible
        /// </summary>
        String passPhrase = @"D'``:]\~ZY|{WVxv.tQsa/.^&\lkFX~}U0zyQwv*)sxwYun4lqj0nmlkjihJI_%cba`Y^W{>=YXQu8NMLQJImMFKDhB*FE>b<A@987[Z:9870543,P*)('&%I)ih~}${Abaw|{t:[wpon4rTSohgle+*haIe^$\aZ~^]\UZSwWVUN6Lp]";
        ...
        /// <summary>
        /// this function will return the encrypted text passed as Parameter
        /// </summary>
        /// <param name="plainText">the plain text given as parameter</param>
        ...
        /// <summary>
        /// decrypts a text passed as a parameter 
        /// </summary>
        ...
        /// <summary>
        /// this function generates a 256 bit array
        /// </summary>
        /// <returns></returns>
